...
const isNegative = (val: string) => {
  ...
  return (
    v.includes("none") ||
    v.includes("n/a") ||
    v.includes("no coating") ||
    v.includes("non-galvanized")
  );
};
const hasHighlight = (val: string) =>
  BADGE_HIGHLIGHTS.some((k) => val.toLowerCase().includes(k.toLowerCase()));
const highlightChips = (val: string) =>
  BADGE_HIGHLIGHTS.filter((k) => val.toLowerCase().includes(k.toLowerCase()));
...
export default function NetHousePage() {
    ...
    () => [
      {
        ...
        paragraphs: [
          ...
          {
            title: "Optimal Light Diffusion",
            text: "Uniform light spread minimizes leaf burn and supports healthy canopy growth.",
          },
          {
            title: "Cooler Microclimate",
            text: "Lower heat stress stabilizes temperatures, enhancing crop vigor in hot regions.",
          },
        ],
      },
      {
        ...
        paragraphs: [
          ...
          },
          {
            ...
            text: "Reduced evaporation preserves irrigation water and maintains ideal humidity levels.",
          },
          {
            title: "Weather Resilience",
            text: "Protects crops from heavy rain and wind, safeguarding delicate plants.",
          },
        ],
      },
      {
        ...
        paragraphs: [
          ...
          },
          {
            ...
            text: "Even light distribution reduces disorders and improves marketable grades.",
          },
          {
            title: "Extended Seasons",
            text: "Controlled microclimate extends growing periods in high-temperature zones.",
          },
        ],
      },
      {
        ...
        paragraphs: [
          ...
          },
          {
            ...
            text: "Lower pest pressure minimizes the need for pesticides, promoting sustainable farming.",
          },
          {
            title: "Higher Yields",
            text: "Protected crops result in better fruit set and increased marketable output.",
          },
        ],
      },
    ],
  ...
  const stats = [
    {
      value: "Light Control",
      label: "Balanced Diffusion",
      icon: ThermometerSun,
    },
    { value: "Heat Reduction", label: "Cooler Canopy", icon: Leaf },
    {
      value: "Pest Protection",
      label: "Reduced Infestation",
      icon: ShieldCheck,
    },
  ...
  const comparisonData: ComparisonRow[] = [
    {
      feature: "Height of Structure",
      dhanvantri: "6.8M to 7.2M",
      others: "6.2M to 6.5M",
    },
    {
      feature: "Side Ventilation",
      dhanvantri: "4 meters",
      others: "2.5 meters",
    },
    {
      feature: "Top Vent",
      dhanvantri: "1.2 to 1.4 meters",
      others: "0.9 meters",
    },
    {
      feature: "Pipe Quality",
      dhanvantri: "375-400 GSM",
      others: "150-250 GSM",
    },
    {
      feature: "Nut Bolts",
      dhanvantri: "22 Micron Zinc Coated",
      others: "No Coating",
    },
    {
      feature: "Foundation",
      dhanvantri: "76mm, 2mm Thick",
      others: "63mm, 1.6mm Thick",
    },
    {
      feature: "Door",
      dhanvantri: "Aluminium Double Sliding",
      others: "Basic GI Door",
    },
    {
      feature: "Gutter",
      dhanvantri: "1.6mm, 275 GSM",
      others: "0.6-1mm, Non-Galvanized",
    },
    { feature: "End Gutters", dhanvantri: "Yes, both ends", others: "N/A" },
    {
      feature: "Shade Net Mechanism",
      dhanvantri: "Pulley System",
      others: "Hook Mechanism",
    },
    {
      feature: "Reinforcement",
      dhanvantri: "Multiple provided",
      others: "None",
    },
    {
      feature: "Hockey Pipe",
      dhanvantri: "Square Pipes",
      others: "Round Pipes",
    },
    {
      feature: "Tonnage",
      dhanvantri: "20-21 Tonnes Steel",
      others: "16 Tonnes Steel",
    },
    ...
    {
      feature: "Shade/Insect Net",
      dhanvantri: "Dhanvantri Farms",
      others: "Local",
    },
    { feature: "Connectors", dhanvantri: "Israeli-designed", others: "Local" },
    {
      feature: "Other Features",
      dhanvantri: "Curtain Box, FLC",
      others: "None",
    },
    {
      feature: "Agronomist Support",
      dhanvantri: "1 Year Free",
      others: "None",
    },
  ];
  ...
  const filteredRows = useMemo(() => {
    ...
    return comparisonData.filter(
      (r) =>
        ...
        r.dhanvantri.toLowerCase().includes(q) ||
    ...
    <main className="bg-white text-gray-900">
      ...
      >
        <div className="absolute inset-0">
          <Image
            src="/service/net/hero.jpg"
            alt="Dhanvantri Farms Net House background"
            fill
            sizes="100vw"
            priority
            ...
            <motion.div variants={fadeUp}>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight">
                ...
                <span className="text-lime-300">
                  Dhanvantri Farms Net Houses
                </span>
              </h1>
              <div className="w-24 h-1.5 bg-lime-400 rounded-full my-6" />
              <p className="text-lg md:text-xl text-green-100/95 max-w-2xl">
                Dhanvantri Farms’ net houses optimize light, temperature, and
                humidity while protecting crops from pests and harsh weather.
              </p>
              <p className="text-lg md:text-xl text-green-100/95 max-w-2xl mt-3">
                Achieve higher yields and consistent quality with
                cost-effective, sustainable solutions tailored to your farm.
              </p>
      ...
      <section id="highlights" className="bg-white">
        <div className="container mx-auto px-4 py-16 md:py-20">
          ...
          >
            ...
            >
              Dhanvantri Farms’ net houses create an ideal microclimate, protect
              crops, and enhance yields with sustainable, cost-effective
              designs.
            </motion.p>
            <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <motion.div
                variants={fadeUp}
                className="p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition group"
              >
                ...
                <p className="text-gray-600">
                  Dhanvantri Farms’ shade nets reduce heat stress, maintaining
                  optimal crop temperatures.
                </p>
              </motion.div>
              <motion.div
                variants={fadeUp}
              ...
              >
                ...
                <p className="text-gray-600">
                  Lower evaporation rates conserve water and stabilize humidity
              ...
              >
                ...
                <p className="text-gray-600">
                  Dhanvantri Farms’ insect nets block pests, reducing crop
      ...
      <section id="types" className="bg-gray-50">
        <div className="container mx-auto px-4 py-16 md:py-20">
          ...
          >
            Types of{" "}
            <span className="text-green-700">Dhanvantri Farms Net Houses</span>
          </motion.h2>
              ...
              >
                <div className="lg:col-span-2">
                  ...
                  <button className="mt-6 px-5 py-2.5 bg-green-700 text-white rounded-lg font-medium hover:bg-green-800 transition">
                    Discover Dhanvantri Farms Net Houses
                  </button>
                </div>
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent opacity-0 hover:opacity-100 transition-opacity flex items-end p-4">
                      <span className="text-white text-sm">
                        Dhanvantri Farms’ {active.title} overview
                      </span>
                    </div>
                  </motion.div>
                </div>
              ...
              {[
                {
                  ...
                  text: "Dhanvantri Farms’ nets moderate heat, ensuring optimal crop conditions.",
                },
                {
                  icon: Layers,
                  title: "Light Optimization",
                  text: "Diffused light prevents scorching and supports uniform crop growth.",
                },
                {
                  icon: CloudRain,
                  title: "Weather Shield",
                  text: "Protects crops from rain, wind, and hail for safer production.",
                },
                {
                  icon: Droplets,
                  title: "Water Savings",
                  text: "Reduces evaporation, conserving water and maintaining humidity.",
                },
                {
                  icon: ShieldCheck,
                  title: "Pest Control",
                  text: "Blocks pests and birds, minimizing crop loss and chemical use.",
                },
                {
                  icon: LineChart,
                  title: "Cost-Effective",
                  text: "Lower build and maintenance costs than greenhouses.",
                },
                {
                  icon: Timer,
                  title: "Longer Seasons",
                  text: "Extends growing periods for earlier and later harvests.",
                },
                {
                  icon: Sprout,
                  title: "Improved Quality",
                  text: "Stable microclimate ensures consistent, high-quality crops.",
                },
              ].map((card) => (
                <motion.div
                  key={card.title}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 mt-3">
              Compare our superior net house designs and features against
              ...
              <div className="divide-y divide-gray-200">
                {filteredRows.map((row, idx) => {
                  ...
                  return (
                    <div
                      key={row.feature + idx}
                      className="grid grid-cols-12 px-6 py-4 items-start hover:bg-gray-50/70 transition"
                    >
                      ...
                      <div className="col-span-4">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {chips.map((c) => (
                            <span
                              key={c}
                              className="inline-flex items-center rounded-full bg-lime-500/15 text-green-800 border border-lime-400/40 px-2 py-0.5 text-xs font-medium"
                            >
                              {c}
                            </span>
                          ))}
                      ...
                      <div className="col-span-4">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {!neg &&
                          row.others.toLowerCase().includes("local") ? (
                      ...
                      <div>
                        ...
                        <div className="mt-1 flex flex-wrap gap-1.5">
                          {chips.map((c) => (
                            <span
                              key={c}
                              className="inline-flex items-center rounded-full bg-lime-500/15 text-green-800 border border-lime-400/40 px-2 py-0.5 text-[11px] font-medium"
                            >
                              {c}
                            </span>
                          ))}
      ...
      <section id="faq" className="bg-gray-50">
        <div className="container mx-auto px-4 py-16 md:py-20">
          ...
          <div className="mt-8 max-w-3xl mx-auto space-y-4">
            {[
              {
                q: "Which shade percentage is best for Dhanvantri Farms net houses?",
                a: "Dhanvantri Farms recommends 35–50% for vegetables and ornamentals, while 75% suits shade-loving crops and nurseries.",
              },
              {
                q: "How does Dhanvantri Farms’ insect net house work?",
                a: "Our fine mesh blocks pests and birds while allowing airflow and light, reducing chemical use and crop loss.",
              },
              {
                q: "Are Dhanvantri Farms net houses cheaper than greenhouses?",
                a: "Yes, our net houses are more cost-effective to build and maintain, offering robust microclimate control.",
              },
              {
                q: "What crops thrive in Dhanvantri Farms net houses?",
                a: "Leafy greens, herbs, ornamentals, and heat-sensitive vegetables benefit from our tailored shade and insect nets.",
              },
              {
                q: "Do Dhanvantri Farms net houses save water?",
                a: "Yes, reduced evaporation lowers irrigation needs, making our net houses water-efficient.",
              },
            ].map((item, idx) => (
              <motion.div
                key={idx}
      ...
      >
        <div className="absolute inset-0">
          <Image
            src="/images/nethouse/cta.jpg"
            alt="Dhanvantri Farms Net House call to action"
            fill
            sizes="100vw"
        ...
        <div className="relative z-10 container mx-auto px-4 py-16 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl md:text-4xl font-extrabold">
              Start Your Dhanvantri Farms Net House Project
            </h2>
            <p className="text-green-100 mt-3">
              Optimize your farm with our shade and insect net solutions for
