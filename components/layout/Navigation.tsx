  ...
  const menuItems = [
    {
      ...
      href: '/net-house',
      dropdown: [
        { label: 'Net House Solutions', href: '/net-house' },
        { label: 'Designs & Types', href: '/net-house#types' },
        { label: 'Key Benefits', href: '/net-house#advantages' },
        { label: 'Performance Data', href: '/net-house#stats' },
        { label: 'Comparison Guide', href: '/net-house#comparison' },
        { label: 'FAQ', href: '/net-house#faq' },
        { label: 'Get Quote', href: '/net-house#cta' },
      ],
    },
    {
      label: 'Hydroponics',
      href: '/hydroponics',
      dropdown: [
        { label: 'System Overview', href: '/hydroponics#intro' },
        { label: 'Farming Methods', href: '/hydroponics#types' },
        { label: 'Benefits & ROI', href: '/hydroponics#advantages' },
        { label: 'Success Stories', href: '/hydroponics#stats' },
        { label: 'Expert Support', href: '/hydroponics#why-dhanvantri' },
        { label: 'FAQ', href: '/hydroponics#faq' },
      ],
    },
    {
      label: 'Polyhouse',
      href: '/polyhouse',
      dropdown: [
        { label: 'Polyhouse Overview', href: '/polyhouse' },
        { label: 'Types & Designs', href: '/polyhouse/polyhouse-advantages#menu1' },
        { label: 'Advanced Features', href: '/polyhouse/polyhouse-advantages#menu2' },
        { label: 'Investment Planning', href: '/polyhouse/polyhouse-advantages#menu3' },
        { label: 'Benefits & ROI', href: '/polyhouse/polyhouse-advantages#menu4' },
        { label: 'Considerations', href: '/polyhouse/polyhouse-advantages#menu5' },
      ],
    },
    {
      ...
      dropdown: [
        { label: 'Organic Farming Guide', href: '/organic-farming' },
        { label: 'Visual Story', href: '/organic-farming#story' },
        { label: 'Practice Gallery', href: '/organic-farming#gallery' },
        { label: 'Get Started', href: '/organic-farming#cta' },
      ],
    },
    {
      label: 'Warehouse',
      ...
      dropdown: [
        ...
        { label: 'Storage Systems', href: '/warehouse#storage' },
        { label: 'Operations Flow', href: '/warehouse#flow' },
        { label: 'Comparison Guide', href: '/warehouse#compare' },
        { label: 'FAQ', href: '/warehouse#faq' },
        { label: 'Get Started', href: '/warehouse#cta' },
      ],
    },
    {
      label: 'Cold Storage',
      href: '/cold-storage',
      dropdown: [
        { label: 'Cold Storage Systems', href: '/cold-storage' },
        { label: 'Temperature Zones', href: '/cold-storage#zones' },
        { label: 'Infrastructure', href: '/cold-storage#infra' },
        { label: 'Operations', href: '/cold-storage#process' },
        { label: 'Comparison Guide', href: '/cold-storage#compare' },
      ],
    },
