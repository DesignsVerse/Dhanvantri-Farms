...
if (!fs.existsSync(DATA_FILE)) {
  const defaultContent = {
    ...
    "services": [
      ...
      },
      {
        ...
        "description": "Premium saffron cultivation",
        "image": "/8.jpg",
        "href": "/indoor-saffron",
        "order": 7
      },
      {
        ...
        "description": "Modern mushroom cultivation",
        "image": "/7.jpg",
        "href": "/mushroom",
        "order": 8
      }
    ...
    "footer": {
      ...
      "services": [
        {
          "label": "Polyhouse Solutions",
          "href": "/polyhouse"
        },
        {
          "label": "Polyhouse Advantages",
          "href": "/polyhouse/polyhouse-advantages"
        },
        {
  ...
  console.log('✅ CMS data file initialized successfully');
} else {
  console.log('✅ CMS data file already exists');
}